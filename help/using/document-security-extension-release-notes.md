...
AEM Document Security Extension for Microsoft Office はビルトインの保護機能を使用して、ドキュメント、ワークシートおよびプレゼンテーションを保護します。 この操作により、Excel、Word、および PowerPoint のメニューオプションの一部が無効になります。
